  ...
  return (
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-blue-200 text-sm leading-relaxed">
              Transférez de l'argent entre le Maroc, la Côte d'Ivoire, le Sénégal, la Guinée-Bissau, le Mali, le Niger et le Burkina Faso. Rapide, sécurisé, humain.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-blue-200">
              {[
                ...
                <li key={href}>
                  <a href={href} className="hover:text-gold-DEFAULT transition-colors">
                    → {label}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-blue-200">
          <p>© 2025 AfriGate. Tous droits réservés.</p>
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-green-400"></span> Transferts sécurisés
            </span>
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-gold-DEFAULT"></span> Données protégées
            </span>
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-blue-300"></span> Support humain
            </span>
          </div>
        </div>
      </div>
