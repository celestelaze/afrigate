...
Merci de prendre en charge ma demande. 🙏`
    ...
    return `https://wa.me/221776997546?text=${encodeURIComponent(msg)}`
  }
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          {step === 4 && (
            <div>
              ...
              {/* Direct <a> link — 100% fiable sur iOS Safari et Android */}
              <a
                href={buildWhatsAppURL()}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-white font-bold text-base shadow-lg"
